...
# # ============================================================================================================================
# Сделать декоратор, который считает время выполнения функции (через метод time())
# import time
# import math
...
# 2. Сделать декоратор, который проверяет пароль перед запуском функции
...
# # ============================================================================================================================
# Последние посещённые страницы (cookies)
# Цель: показать, что cookies можно использовать для истории пользователя.
# Задание:
# Сохраняй URL каждой просмотренной страницы в cookies.
# На главной странице показывай “Вы недавно посещали:



# Мини-корзина товаров (session)
# Цель: показать, как хранить временные данные в сессии.
# Задание:
# Создай список товаров.
# Добавь кнопку “Добавить в корзину”.
# Корзина хранится в request.session['cart'].
# Покажи количество добавленных товаров.
# Усложнение:
# Добавь кнопку “Очистить корзину”