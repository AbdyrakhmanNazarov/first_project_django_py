...
from .views import (
    MainAdminView, StudentListView, StudentDetailView, StudentCreateView,
    StudentUpdateView, StudentDeleteView, GroupCreateView, TagCreateView,
    UserListView, student_payment_page, student_payment_view,
    set_cookie_view, get_cookie_view, set_session_view, get_session_view,
    visit_counter, delete_cookie_view, delete_session_view
)
